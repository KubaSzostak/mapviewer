...
(function (languative) {
    ...
    languative.getDictionary = getDictionary; // getDictionary
    ...
    languative.getDictionaryFromHtml = getDictionaryFromHtml; // getDictionaryFromHtml
    ...
    languative.changeLanguage = changeLanguage; // changeLanguage()
    ...
    languative.modifyDictionary = modifyDictionary; // modifyDictionary()
